...
ggplot(testgraph, aes(x=year, y=n, fill=interaction(lap,ismajor))) + geom_histogram(stat="identity") +  scale_fill_brewer(labels=c("open minor", "lap minor", "open major", "lap major"), name="Procedure type")
